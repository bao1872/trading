...
| 2026-03-05 | stock_list | 新增股票列表，存储用户关注的股票清单 |
...
**索引**：
- `idx_stock_list_name` ON (stock_name)
- `idx_stock_list_code` ON (ts_code)

**唯一约束**：UNIQUE(stock_name)
