...
# ==================== 数据分割 ====================
# train/val/test 时间分割点（基于 selection_date）
TRAIN_END = "2025-11-30"     # train: 2025-07 ~ 2025-11 (5个月)
VAL_END = "2026-02-28"       # val:   2025-12 ~ 2026-02 (3个月)
                              # test:  2026-03 ~  (2个月+)
# 训练集: selection_date <= TRAIN_END - EMBARGO_DAYS
# 验证集: TRAIN_END < selection_date <= VAL_END
# 测试集: selection_date > VAL_END
